...
export const Activities = [
    ...
    {
        anonymous: true,
        description: "Displays the list of available ways to import data into Galaxy.",
        icon: "upload",
        id: "data_import",
        mutable: false,
        optional: false,
        ...
        title: "Data Import",
        to: null,
        tooltip: "Import data into Galaxy by uploading, download from URL or using data libraries",
        visible: true,
    },
    {
        anonymous: true,
