...
class ErrorAnalysisAgent(BaseGalaxyAgent):
    ...
    def _get_simple_system_prompt(self) -> str:
        ...
        IMPORTANT: If the query includes "Context from history analysis:" that context ALREADY CONTAINS the error details. Use that information directly to provide a SPECIFIC solution. Do NOT ask for more details or give generic advice.
