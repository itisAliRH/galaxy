...
class ConfigSerializer(base.ModelSerializer):
    ...
    def add_serializers(self):
        ...
        self.serializers: dict[str, base.Serializer] = {
            ...
            "enable_user_profile_pages": _use_config,
            "user_profile_max_links": _use_config,
            "user_profile_max_section_items": _use_config,
            "user_profile_max_section_item_ids": _use_config,
            "user_profile_max_starred_tools": _use_config,
